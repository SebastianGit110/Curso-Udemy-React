...
// Recibo { todo, onDeleteTodo, onToggleTodo } y deberian serobligatorias usando proptypes porque yo las estoy usando en mi componente y si no las recibo pueden haber errores, la otra opcion es hacer condiciones en los onclick para decir si recibo la funcion, que se ejecute, sino, que se ejecute otra cosa
